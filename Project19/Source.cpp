...
string quiz[15][6] = {
	...
	{"Как вставляются комментарии в С++? 2","/*Это комментарий","#Это комментарий","//Это комментарий","<!--Это комментарий-->","//Это комментарий"},
	{"Вопрос 3","Ответ 13","Ответ 2","Ответ 3","Ответ 4","Ответ 4"},
	{"Вопрос 4","Ответ 14","Ответ 2","Ответ 3","Ответ 4","Ответ 4"},
	{"Вопрос 5","Ответ 15","Ответ 2","Ответ 3","Ответ 4","Ответ 4"},
	{"Вопрос 6","Ответ 16","Ответ 2","Ответ 3","Ответ 4","Ответ 4"},
